export const environment = {
  ...
  trackingUrl: 'http://localhost:8090/api',
  ...
  // WebSocket URLs (sans /api) - Utilise Spring Boot pour tracking (8083) et Node.js pour WebSocket (8090)
  trackingWsUrl: 'http://localhost:8090',
  livreursWsUrl: 'http://localhost:8084',
  vehiclesWsUrl: 'http://localhost:8086',
  // URL du service tracking pour les manifestes
  trackingServiceUrl: 'http://localhost:8090'
};
